...
DMidTermInstallation::DMidTermInstallation(QWidget *parent)
    : QWidget(parent)
    ...
    , pCenterLabel(new DLabel(QString(tr("请选择中期安装"))))
    , pDCommandLinkButtonClear(new DCommandLinkButton(tr("全部清除")))
{
    ...
    DLabel *pDlabel = new DLabel(QString(tr("中期安装")));
    pDCommandLinkButtonClear->setHidden(true);
    connect(pDCommandLinkButtonClear, &DCommandLinkButton::clicked, this, &DMidTermInstallation::ClearbuttonClicked);
    QFont fontBold;
    ...
    connect(pDCommandLinkButtonChoice, &DCommandLinkButton::clicked, this, &DMidTermInstallation::LinkbuttonClicked);
    ...
    connect(pDListWidgetClear, &DListWidgetClear::indexfoucs, this, &DMidTermInstallation::itemFoucs);
    ...
    connect(this, &DMidTermInstallation::iconBtnCliked, pDListWidgetClear, &DListWidgetClear::clearButtnCliked);
...
void DMidTermInstallation::LinkbuttonClicked()
{
...
void DMidTermInstallation::ClearbuttonClicked()
{
    pFileNameList->clear();
...
void DMidTermInstallation::itemFoucs(QMouseEvent *e)
{
